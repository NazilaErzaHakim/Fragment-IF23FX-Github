...
import com.uti.fragment_if23fx.databinding.FragmentMenu3Binding
...
class Menu3Fragment : Fragment() {
 ...
 //        devinisikan variabel "binding"
        val binding = FragmentMenu3Binding.inflate(layoutInflater)
 //       tanpilkan hasil parameter "content3" dari MainActivity
